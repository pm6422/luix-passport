...
public abstract class MdcWrapperExecutors {
    /**
    ...
    public static ScheduledExecutorService newSingleThreadScheduledExecutor() {
        return new DelegatedScheduledExecutorServiceImpl(new ScheduledThreadPoolExecutor(1));
    }
    ...
    public static ScheduledExecutorService newSingleThreadScheduledExecutor(ThreadFactory threadFactory) {
        return new DelegatedScheduledExecutorServiceImpl
    ...
    public static ScheduledExecutorService unconfigurableScheduledExecutorService(ScheduledExecutorService executor) {
        ...
        return new DelegatedScheduledExecutorServiceImpl(executor);
    }
    ...
    static class FinalizeDelegatedExecutorService extends DelegatedExecutorService {
        FinalizeDelegatedExecutorService(ExecutorService executor) {
            super(executor);
        }
     ...
     */
    static class DelegatedScheduledExecutorServiceImpl extends DelegatedExecutorService implements ScheduledExecutorService {
