package com.luixtech.passport.oauth2;
...
import static com.luixtech.passport.domain.oauth2.OAuth2Client.*;
...
@Slf4j
public class OAuth2OAuth2AuthorizationIT {
    private static final String    REDIRECT_URI = "https://www.baidu.com";
    private static final String    USERNAME     = "louis";
