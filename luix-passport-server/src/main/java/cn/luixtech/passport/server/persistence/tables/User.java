...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, Instant> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.INSTANT.nullable(false), this, "");

    /**
     * The column <code>public.user.updated_by</code>.
     */
    public final TableField<UserRecord, String> UPDATED_BY = createField(DSL.name("updated_by"), SQLDataType.VARCHAR(50), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_USER_DATE_TIME_FORMAT_ID, Indexes.IDX_USER_TIME_ZONE_ID);
    }
    ...
    public List<UniqueKey<UserRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.USER_EMAIL_KEY, Keys.USER_MOBILE_NO_KEY);
    }
     ...
     * <code>public.supported_date_time_format</code> table.
     */
    public SupportedDateTimeFormat supportedDateTimeFormat() {
        if (_supportedDateTimeFormat == null)
            _supportedDateTimeFormat = new SupportedDateTimeFormat(this, Keys.USER__FK_USER_DATE_TIME_FORMAT_SUPPORTED_DATE_TIME_FORMAT_ID);

        return _supportedDateTimeFormat;
    }
