...
public class DataDictRecord extends UpdatableRecordImpl<DataDictRecord> implements Record11<String, String, String, String, String, String, Boolean, String, Instant, String, Instant> {
    ...
    @Override
    public Row11<String, String, String, String, String, String, Boolean, String, Instant, String, Instant> valuesRow() {
    ...
    @Override
    public DataDictRecord value11(Instant value) {
        setModifiedAt(value);
        return this;
    }

    @Override
    public DataDictRecord values(String value1, String value2, String value3, String value4, String value5, String value6, Boolean value7, String value8, Instant value9, String value10, Instant value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DataDictRecord(String id, String num, String categoryCode, String dictCode, String dictName, String remark, Boolean enabled, String createdBy, Instant createdAt, String modifiedBy, Instant modifiedAt) {
        super(DataDict.DATA_DICT);
