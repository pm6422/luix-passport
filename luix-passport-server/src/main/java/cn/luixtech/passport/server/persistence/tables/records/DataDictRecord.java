...
public class DataDictRecord extends UpdatableRecordImpl<DataDictRecord> implements Record11<String, String, String, String, String, String, Boolean, Instant, String, Instant, String> {
    ...
    @Override
    public Row11<String, String, String, String, String, String, Boolean, Instant, String, Instant, String> valuesRow() {
    ...
    @Override
    public DataDictRecord value8(Instant value) {
        setCreatedAt(value);
        return this;
    }

    @Override
    public DataDictRecord value9(String value) {
        setCreatedBy(value);
        return this;
    }

    @Override
    public DataDictRecord value10(Instant value) {
        setModifiedAt(value);
        return this;
    }

    @Override
    public DataDictRecord value11(String value) {
        setModifiedBy(value);
        return this;
    }

    @Override
    public DataDictRecord values(String value1, String value2, String value3, String value4, String value5, String value6, Boolean value7, Instant value8, String value9, Instant value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DataDictRecord(String id, String num, String categoryCode, String dictCode, String dictName, String remark, Boolean enabled, Instant createdAt, String createdBy, Instant modifiedAt, String modifiedBy) {
        super(DataDict.DATA_DICT);
